...
def run_experiment(args_in):
    ...
    print(f"the arguments passed to model.fit are: {args_in.seed}")
    print('\nTraining VI-DPP...')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='nba_df', help="Dataset name; acceptable values [mimic, mooc, retweet, stackOverflow, nba_df].")
    parser.add_argument('--Q', type=int, default=1, help="Number of past events taking into account for computing the data likelihood.")
